...
func (j *jsiiProxy_Pod) DockerRegistryAuth() ISecret {
	var returns ISecret
	_jsii_.Get(
		j,
		"dockerRegistryAuth",
...
func (j *jsiiProxy_Pod) ShareProcessNamespace() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (p *jsiiProxy_Pod) AttachContainer(cont Container) {
	if err := p.validateAttachContainerParameters(cont); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		p,
