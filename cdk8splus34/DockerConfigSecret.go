...
func (d *jsiiProxy_DockerConfigSecret) EnvValue(key *string, options *EnvValueFromSecretOptions) EnvValue {
	if err := d.validateEnvValueParameters(key, options); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DockerConfigSecret) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
