...
type BasicDeviceV1Alpha3 struct {
	...
	ConsumesCounters *[]*DeviceCounterConsumptionV1Alpha3 `field:"optional" json:"consumesCounters" yaml:"consumesCounters"`
	...
	Taints *[]*DeviceTaintV1Alpha3 `field:"optional" json:"taints" yaml:"taints"`
}
