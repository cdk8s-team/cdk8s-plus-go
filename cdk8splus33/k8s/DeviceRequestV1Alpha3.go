...
type DeviceRequestV1Alpha3 struct {
	...
	FirstAvailable *[]*DeviceSubRequestV1Alpha3 `field:"optional" json:"firstAvailable" yaml:"firstAvailable"`
	...
	Tolerations *[]*DeviceTolerationV1Alpha3 `field:"optional" json:"tolerations" yaml:"tolerations"`
}
