...
type PodSpec struct {
	...
	DnsPolicy IoK8SApiCoreV1PodSpecDnsPolicy `field:"optional" json:"dnsPolicy" yaml:"dnsPolicy"`
	...
	// - `"Never"`
	// - `"OnFailure"`.
	RestartPolicy IoK8SApiCoreV1PodSpecRestartPolicy `field:"optional" json:"restartPolicy" yaml:"restartPolicy"`
