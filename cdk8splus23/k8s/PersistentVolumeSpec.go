...
type PersistentVolumeSpec struct {
	...
	PersistentVolumeReclaimPolicy IoK8SApiCoreV1PersistentVolumeSpecPersistentVolumeReclaimPolicy `field:"optional" json:"persistentVolumeReclaimPolicy" yaml:"persistentVolumeReclaimPolicy"`
