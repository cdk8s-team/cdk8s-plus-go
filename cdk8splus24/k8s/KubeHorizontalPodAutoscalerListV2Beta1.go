...
import (
	...
	"github.com/cdk8s-team/cdk8s-plus-go/cdk8splus24/v2/k8s/internal"
)
...
func KubeHorizontalPodAutoscalerListV2Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeHorizontalPodAutoscalerListV2Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
